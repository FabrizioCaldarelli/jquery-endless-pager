...
;(function($) {
	...
	// Constructor
	var Endlesspager = function(element, options) {
	...
	Endlesspager.prototype = {
		...
		_init : function() {
			...
			if (this.settings.activateOnStart) {
				this.activate();
			}

			this._execHidePagination();
			...
			var scrollListener = function() {
				...
				$(scrollContainer).on("scroll", function() {
					...
					if (($element.hasClass(self.cssClassActive) == false) || (self.settings.updatingInfiniteScroll == true)) {
						return;
					};
	...
	$.fn.endlesspager = function(options) {
		...
		if (options === undefined || typeof options === 'object') {
			...
			if (error) {
				throw new Error('No method "' + options + '" in Endlesspager.');
			}
